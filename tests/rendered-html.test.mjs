...
test("ships the trading agent workspace instead of the starter preview", async () => {
  ...
  assert.match(expertWorkspace, /专家 · 技能/);
  assert.match(expertWorkspace, /className="expert-skill-sections"/);
  assert.match(expertWorkspace, /className="expert-skill-section"/);
  assert.match(expertWorkspace, /className="expert-skill-section-header"/);
  assert.match(expertWorkspace, /className="expert-skill-empty"/);
  assert.doesNotMatch(expertWorkspace, /className="agent-filter-tabs"/);
  assert.doesNotMatch(expertWorkspace, /className="skill-agent-tag"/);
  assert.doesNotMatch(expertWorkspace, /selectedAgentId|selectedSkillCount/);
  ...
  assert.doesNotMatch(css, /\.agent-filter-tabs/);
  ...
  assert.match(css, /\.expert-skill-sections/);
  assert.match(css, /\.expert-skill-section/);
  assert.match(css, /\.expert-skill-section-header/);
  assert.match(css, /\.expert-skill-empty/);
  assert.doesNotMatch(css, /\.skill-agent-tag/);
  ...
  assert.match(workflow, /codex\/交易智能助手-v2\.3/);
  ...
  assert.match(workflow, /versions\/flat-skill-directory/);
